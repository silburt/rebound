...
axes[1].plot(time, HSF, 'o', ms=ms, markeredgecolor='none')
axes[2].plot(time, (a1 - a1.mean())/a1.std(), 'o', ms=ms, markeredgecolor='none',label='planet 1')
axes[2].plot(time, (a2 - a2.mean())/a2.std(), 'o', ms=ms, markeredgecolor='none',label='planet 2')
axes[2].plot(time, (a3 - a3.mean())/a3.std(), 'o', ms=ms, markeredgecolor='none',label='planet 3')
...
axes[2].set_ylabel('normalized semi-major axis', fontsize=13)
