...
int main(int argc, char* argv[]){
    ...
    //Earth
    double m_earth = 3e-6, r_earth=4.26349651e-5;
    {
    ...
    {
        double a=3.7, m=5*m_earth, e=0, inc = reb_random_normal(0.00001);
        struct reb_particle p1 = {0};
        p1 = reb_tools_orbit_to_particle(r->G, star, m, a, e, inc, 0, 0, reb_random_uniform(0,2*M_PI));
        p1.r = 2.27075425e-5;
        reb_add(r, p1);
    ...
    double a_uranus = 19.18;
    double growthfacJ = 1.5, growthfacS = 1.5;
    //Jupiter
    {
        double a_real = 5.2, m_real = 0.0009543;
        double a=a_uranus-10, m=0.0009543/growthfacJ, e=0, inc = reb_random_normal(0.00001);
        struct reb_particle p1 = {0};
        p1 = reb_tools_orbit_to_particle(r->G, star, m, a, e, inc, 0, 0, reb_random_uniform(0,2*M_PI));
        p1.r = 0.00046732617;
        reb_add(r, p1);
    ...
    {
        double a_real = 9.54;
        double a=a_uranus-7, m=0.0002857/growthfacS, e=0.9, inc=reb_random_normal(0.00001);
    ...
    tau_e[iJ] = mig_rate/K;
    tau_m[iJ] = pow(growthfacJ, (r->dt/tau_a[iJ]));
    tau_a[iJ+1] = 2*mig_rate;                           //Saturn - mass growth rate too!
    tau_e[iJ+1] = mig_rate/K;
    tau_m[iJ+1] = pow(growthfacS, (r->dt/tau_a[iJ]));
