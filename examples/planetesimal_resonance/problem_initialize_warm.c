...
int main(int argc, char* argv[]){
    ...
    char eia_out[100] = {0}; strcat(eia_out, output_name); strcat(eia_out, "_eiasnapshot_t=");
    system(syss);
    ...
    //post integration
    char out_time[10] = {0}; sprintf(out_time,"%.0f",r->t); strcat(eia_out,out_time); strcat(eia_out,".txt");
    eia_snapshot(r, eia_out);
...
void eia_snapshot(struct reb_simulation* r, char* dist){
    //name
