...
int main(int argc, char* argv[]){
    ...
    r->ri_hermes.hill_switch_factor = atof(argv[3]);  //Hill radii
    ...
    //planet 1
    double a1=1, m1=2.3*m_earth, e1=0, inc1=reb_random_normal(0.00001);
    ...
    double amin = 0.42, amax = 1.42;   //10.5AU on each side of the planet
...
void heartbeat(struct reb_simulation* r){
    if(r->t > tlog_output || r->t > tlin_output){//log output or linear output!!
        ...
        double E = reb_tools_energy(r) + r->energy_offset;
