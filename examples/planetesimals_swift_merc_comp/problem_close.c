...
int main(int argc, char* argv[]){
    ...
    r->ri_hermes.radius_switch_factor = 30.;         //X*radius
    ...
    //planet
    {
        double a=0.15, m=5e-5, e=0.9, inc=reb_random_normal(0.00001);
    ...
    while(r->N<N_planetesimals + r->N_active){
        ...
        pt = reb_tools_orbit_to_particle(r->G, star, planetesimal_mass, a, 0.9, inc, Omega, apsis,phi);
		pt.r 		= 4e-5;
        pt.hash = r->N;
		reb_add(r, pt);
    }
